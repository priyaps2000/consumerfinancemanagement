...
//	public User findUserByuName(String userName);
	...
	@Query(value = "SELECT * FROM user u WHERE u.user_Name = :userName LIMIT 1", nativeQuery = true)
	...
	@Query(value = "SELECT * FROM user u WHERE u.email_id = ?1 LIMIT 1", nativeQuery = true)
